...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { date: @testimonial.date, name: @testimonial.name, stars: @testimonial.stars, testimonial: @testimonial.testimonial }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { date: @testimonial.date, name: @testimonial.name, stars: @testimonial.stars, testimonial: @testimonial.testimonial }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
