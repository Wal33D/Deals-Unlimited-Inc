...
class MeetsControllerTest < ActionController::TestCase
  ...
  test "should create meet" do
    assert_difference('Meet.count') do
      post :create, meet: { about: @meet.about, duration: @meet.duration, employee_name: @meet.employee_name, headshot: @meet.headshot }
    end
  ...
  test "should update meet" do
    patch :update, id: @meet, meet: { about: @meet.about, duration: @meet.duration, employee_name: @meet.employee_name, headshot: @meet.headshot }
    assert_redirected_to meet_path(assigns(:meet))
  end
